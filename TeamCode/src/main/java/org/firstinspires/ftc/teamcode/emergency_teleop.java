...
public class emergency_teleop extends OpMode {
    ...
    public void init() {
        ...
        launcher.setVeloCoefficients(.6, 0, 0);
    ...
    public void loop() {
        ...
        double distanceToTarget = 58; // inches
        double denom;
        ...
        SimpleMotorFeedforward feedforward =
                new SimpleMotorFeedforward(.2, kV);

        if (gamepad1.left_trigger !=0) {
            launcher.setVelocity(feedforward.calculate(velocityTPS*gamepad1.left_trigger)+adder);
        } else {
